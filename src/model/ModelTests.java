...
//        void gameCreate() {
//            game = new Game();
//            neighborCell = new Tuple(game.snake.sourceHeadPosition.getRow(),
//                    (game.snake.sourceHeadPosition.getColumn() + 1) %
...
//        }
        ...
        void updateWithCollisionWithSnakeTest() {
            ...
            assertFalse(game.update(moveDirection));
        }
    ...
    class TupleTests {
        ...
        void equalTupleTest() {
            ...
            assertAll(
                    () -> assertTrue(firstTuple.equals(secondTuple)),
                    () -> assertFalse(firstTuple.equals(thirdTuple)),
                    () -> assertFalse(thirdTuple.equals(null)),
                    () -> assertFalse(thirdTuple.equals("Some string")),
                    () -> assertTrue(secondTuple.equals(secondTuple))
            );
        }
